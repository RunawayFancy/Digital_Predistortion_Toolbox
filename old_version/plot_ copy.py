...
# for chara1 in range(length):
#     for chara2 in range(chara1, length):
#         file_name = "E:/OP/Experiments/0616_2023_pred/DATA/retest_500smooth_CopperLine" + character_set[chara1] + character_set[chara2] + "_TLineCase2_averaged.pkl"
...
#         index.append(character_set[chara1] + character_set[chara2])
#         waveform.append(waveform_dummy)

waveform_AWG =  pickle.load(open("E:/OP/Experiments/0616_2023_pred/DATA/retest_500smooth_BareAWG_new_averaged.pkl", "rb"))# moving_agerage(pickle.load(open("E:/OP/Experiments/0616_2023_pred/DATA/retest_500smooth_BareAWG_new_averaged.pkl", "rb")), window_size)
